"""
run_r8.py - Dispatches Round 8 cloud render to GitHub Actions, monitors execution,
...
JOB_ID = f"gha_hakt_30s_r8_{int(time.time())}"
...
print("=" * 70)
print(f"DISPATCHING ROUND 8 CLOUD RENDER: {JOB_ID}")
print(f"Commit: e74a3e99a1a89b5fc724c7a970926f5a10371878")
...
if local_mp4 and local_mp4.exists():
    ...
    for ts in timestamps:
        ...
        if frame_file.exists():
            ...
            if BRAIN_ARTIFACT_DIR.exists():
                shutil.copy(frame_file, BRAIN_ARTIFACT_DIR / f"r8_frame_{ts:.1f}s.png")

total_elapsed = time.monotonic() - t_start
print("\n" + "=" * 70)
print(f"ROUND 8 CLOUD RENDER COMPLETED in {total_elapsed:.1f}s")
