"""
run_r10.py - Dispatches Round 10 cloud render to GitHub Actions, monitors execution,
...
JOB_ID = f"gha_hakt_30s_r10_{int(time.time())}"
...
print("=" * 70)
print(f"DISPATCHING ROUND 10 CLOUD RENDER: {JOB_ID}")
print(f"Commit HEAD: e2ffe2b")
...
if receipt_files:
    ...
    if BRAIN_ARTIFACT_DIR.exists():
        shutil.copy(out_receipt, BRAIN_ARTIFACT_DIR / "r10_receipt.json")
...
if mp4_files:
    ...
    if BRAIN_ARTIFACT_DIR.exists():
        shutil.copy(local_mp4, BRAIN_ARTIFACT_DIR / "master_r10_render.mp4")
...
if local_mp4 and local_mp4.exists():
    ...
    for ts in timestamps:
        ...
        if frame_file.exists():
            ...
            if BRAIN_ARTIFACT_DIR.exists():
                shutil.copy(frame_file, BRAIN_ARTIFACT_DIR / f"r10_frame_{ts:.1f}s.png")

total_elapsed = time.monotonic() - t_start
print("\n" + "=" * 70)
print(f"ROUND 10 CLOUD RENDER COMPLETED in {total_elapsed:.1f}s")
