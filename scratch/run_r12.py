"""
run_r12.py - Dispatches Round 12 cloud render to GitHub Actions, monitors execution,
...
JOB_ID = f"gha_hakt_30s_r12_{int(time.time())}"
...
print("=" * 70)
print(f"DISPATCHING ROUND 12 CLOUD RENDER: {JOB_ID}")
print(f"Commit HEAD: cdc71e0")
...
if receipt_files:
    ...
    if BRAIN_ARTIFACT_DIR.exists():
        shutil.copy(out_receipt, BRAIN_ARTIFACT_DIR / "r12_receipt.json")
...
if mp4_files:
    ...
    shutil.copy(chosen_mp4, OUTPUT_DIR / "master_r12_render.mp4")
    if BRAIN_ARTIFACT_DIR.exists():
        shutil.copy(chosen_mp4, BRAIN_ARTIFACT_DIR / "master_r12_render.mp4")
...
if local_mp4 and local_mp4.exists():
    ...
    for ts in timestamps:
        ...
        if frame_file.exists():
            ...
            if BRAIN_ARTIFACT_DIR.exists():
                shutil.copy(frame_file, BRAIN_ARTIFACT_DIR / f"r12_frame_{ts:.1f}s.png")

total_elapsed = time.monotonic() - t_start
print("\n" + "=" * 70)
print(f"ROUND 12 CLOUD RENDER COMPLETED in {total_elapsed:.1f}s")
