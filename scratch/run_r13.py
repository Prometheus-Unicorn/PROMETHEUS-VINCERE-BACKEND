"""
run_r13.py - Dispatches Round 13 cloud render to GitHub Actions, monitors execution,
...
JOB_ID = f"gha_hakt_30s_r13_{int(time.time())}"
...
print("=" * 70)
print(f"DISPATCHING ROUND 13 CLOUD RENDER: {JOB_ID}")
print(f"Commit HEAD: e9dbb2f")
...
print("\n" + "=" * 70)
print(f"ROUND 13 CLOUD RENDER COMPLETED in {total_elapsed:.1f}s")
